...
2026-09-23 #215에서 스토어 계정·서명·앱/빌드 이력 확인을 재개했습니다. Play 소유자 인증·Apple 로그인과 배포 설정 확인이 남아 있으며 실제 업로드·공개 준비 완료는 아닙니다. [현재 확인 결과와 후속 순서](docs/work-history/store-readiness-215.md)를 따릅니다.

...
| [ ] | TEST-01 | full-screen golden test 기준 크기 | `docs/testing-guide.md`, `docs/quality-testing-follow-up-plan.md` | #200에서 한글 Pretendard 선행 조건을 해결한 뒤 #199의 `OnboardingPage` `375×812` pilot으로 DPR과 baseline 갱신 규칙을 확정한다. | Ready |
